...
export const MODEL_OPTIONS = ['CosMac-Pro', 'CosMac-Lite', 'CosMac-文案微调', 'CosMac-Vision(封面识别)']
...
const BASE_MODEL: ChannelModel = { model: 'CosMac-Pro', tokenBudget: 500, rateLimit: 60 }
